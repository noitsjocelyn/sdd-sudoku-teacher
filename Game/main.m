...
int main (int argc, const char * argv[]) {
	...
	{	
		[Board->fullGrid addObject:[NSNumber numberWithInteger:fullBoard[ix]]];
		[Board->startGrid addObject:[NSNumber numberWithInteger:startBoard[ix]]];
		[Board->puzzle addObject:[NSNumber numberWithInteger:startBoard[ix]]];
	}
