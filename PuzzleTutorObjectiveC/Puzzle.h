 ...
 *     put in any square. Example: Square 13's available numbers are contained
 *     in spaces 13*9 = 107, which corresponds to 1, and 13*9 + 8 = 115, which
 *     corresponds to 9.
 ...
 *     particular number in a particular 3x3 block. Example: Block 2 has a 1 in  *     it iff blockNums[9] = YES, a 2 in it iff blockNums[10] = YES, a 3 in it
 *     iff blockNums[11] = Yes, etc.
 ...
 * Methods:
 * The methods are described in the impelmentation.
 */
